      ...
      const mockTeams = [
        {
          ...
          members: [
            ...
            { id: 2, name: "Sarah Chen", email: "sarah@example.com", role: "Developer" },
            { id: 3, name: "Michael Brown", email: "michael@example.com", role: "Designer" },
        ...
        },
        {
          ...
          competitionId: 2,
          members: [
            { id: 5, name: "David Wilson", email: "david@example.com", role: "Team Leader" },
            { id: 6, name: "Jessica Taylor", email: "jessica@example.com", role: "Designer" },
            { id: 7, name: "Ryan Martinez", email: "ryan@example.com", role: "UX Researcher" },
          ],
          status: "active",
        ...
        },
        {
          ...
          competitionId: 3,
          members: [
            { id: 8, name: "James Wilson", email: "james@example.com", role: "Team Leader" },
            { id: 9, name: "Olivia Smith", email: "olivia@example.com", role: "ML Engineer" },
            { id: 10, name: "Daniel Lee", email: "daniel@example.com", role: "Data Scientist" },
            { id: 11, name: "Sophia Garcia", email: "sophia@example.com", role: "Backend Developer" },
          ],
          status: "active",
        ...
        },
        {
          ...
          competitionId: 1,
          members: [
            { id: 12, name: "Ethan Clark", email: "ethan@example.com", role: "Team Leader" },
            { id: 13, name: "Ava Rodriguez", email: "ava@example.com", role: "Mobile Developer" },
          ],
          status: "active",
        ...
        },
        {
          ...
          competitionId: 3,
          members: [
            { id: 14, name: "Noah White", email: "noah@example.com", role: "Team Leader" },
            { id: 15, name: "Emma Harris", email: "emma@example.com", role: "Data Engineer" },
            { id: 16, name: "Liam Martin", email: "liam@example.com", role: "ML Engineer" },
          ],
          status: "active",
          createdDate: "2023-10-05",
          projectName: "PredictX",
          projectDescription:
            "A predictive analytics platform for small businesses to forecast sales and inventory needs",
        },
      ]
